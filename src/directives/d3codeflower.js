angular.module('de.devjs.angular.d3codeflower', [])
    .directive('d3codeflower', [function () {
        return {
            restrict: 'E',
            scope: {
                data: '='
            ...
            link: function (scope, element, attrs) {
                ...
                function populate(data) {
                    ...
                    myFlower = new CodeFlower(element[0], width, height);
                ...
                CodeFlower.prototype.update = function (json) {
                    ...
                    this.node.transition()
                        .attr("r", function (d) {
                            return d.children ? 3.5 : Math.pow(d.count, 2 / 5) || 1;
                        });
                ...
                CodeFlower.prototype.flatten = function (root) {
                    ...
                    function recurse(node) {
                        if (node.children) {
                            node.count = node.children.reduce(function (p, v) {
                                return p + recurse(v);
                            }, 0);
                        }
                ...
                CodeFlower.prototype.mouseover = function (d) {
                    this.text.attr('transform', 'translate(' + d.x + ',' + (d.y - 5 - (d.children ? 3.5 : Math.sqrt(d.count) / 2)) + ')')
                        .text(d.name + ": " + d.count + " loc")
                        .style('display', null);
                };
